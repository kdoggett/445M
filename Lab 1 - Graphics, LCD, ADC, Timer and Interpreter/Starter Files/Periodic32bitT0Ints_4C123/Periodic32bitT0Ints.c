...
//  Timer0_Init(&UserTask, 4000);    // initialize timer0 (20,000 Hz)
  Timer0_Init(&UserTask, 5000000); // initialize timer0 (16 Hz)
//  Timer0_Init(&UserTask, 80000000);// initialize timer0 (1 Hz)
//  Timer0_Init(&UserTask, 0xFFFFFFFF); // initialize timer0 (16 Hz)
  EnableInterrupts();
